...
export default function MPVVehicleInpectionInformation() {
  ...
  const handleRequestRenewalDateChanged = (
    newValue: React.SetStateAction<Date>
  ) => {
            ...
            <div className="grid grid-cols-8 pt-4 pb-4 pr-1  pl-1gap-0  ">
              <div className="col-span-2 ...">
                <div className="flex flex-col-2  ...">
                  <div
                    className="text-[13px] text-black font-bold text-left pl-2 pt-2 "
                ...
                <div className="flex flex-col-2  ...">
                  <div className="text-[13px] text-black font-bold text-left pl-2 pt-2">
                    ...
                    <span className="ml-1 text-xs font-normal">
                      THINKER BELL DRIVER & TRAILER UNIT{" "}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <h1>
              ...
              <div className="grid grid-cols-8 pt-4 pb-4 gap-0 ">
                ...
                <div className="col-span-2 ...">
                  <div className="flex flex-col-2  ...">
                    <div className="text-[13px] text-black font-bold text-left pl-2 pt-2">
                      Centre{" "}
                      <span className="ml-2 text-xs font-normal">KMB</span>
                    </div>
                  </div>
                </div>
                <div className="flex flex-row justify-stretch  col-span-2">
                  <div className="text-[13px] text-black font-bold text-left pl-2 pt-2">
                    <span className="text-[red]">*</span>Site
                  </div>
                  ...
                  <div className="flex flex-row">
                    ...
                    <div className=" inline- flex border-2  border-[lightgray] w-[55%] ml-5 items-center">
                      ...
                      <DatePicker
                        ...
                        selected={dateValues}
                        onClick={handleRequestDateChanged}
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="flex justify-end mb-2 mr-1">
                <Button
                  ...
                  onClick={() => navigate("/overallResult")}
                >
                  Confrim
                </Button>
              </div>
...
// MPVVehicleInformation.propTypes = {
//     showMPVVehicleInformation: PropTypes.string,
//     closeMPVVehicleInformation: PropTypes.func,
//   };
