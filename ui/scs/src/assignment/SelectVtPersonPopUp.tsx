    ...
    <>
      <Modal isOpen={showVtPersonPopup} onClose={handleClose} size="5xl">
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col text-sm text-[#00AF8F] gap-1 px-3">
                Select VT Person
              </ModalHeader>
              <ModalBody className="gap-0 ">
                <div className="flex flex-wrap w-full bg-[#cdf6ec] p-2 h-10">
                  <div>
                    <div className="text-md font-bold text-[#00AF8F] text-left">
                      SKC
                    </div>
                  </div>
                </div>
              ...
              <ModalFooter className="px-3">
                ...
                <Button
                  className="text-[#ffffff] bg-[#15bf94] mr-2 float-right border-solid border-2 border-[#00AF8F] rounded"
                  variant="bordered"
                  type="submit"
                  size="sm"
                  fond-bold
