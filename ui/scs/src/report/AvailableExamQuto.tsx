...
import AvailableVehicleClassPopup from "./AvailableVehicleClassPopup";
...
function AvailableExamQuto(){
  const [checkedData, setCheckedData] = useState(ExamQuto);
  const [allCheckedData, setAllCheckedData] = useState(true);
  const [fromDate, setFromDate] = useState(new Date());
  const [toDate, setToDate] = useState(new Date());
 const [showAvailableVehicleClassPopup,setAvailableVehicleClassPopup] = useState(false); 
  const handleAvailableVehicleClassPopup = () => {
    setAvailableVehicleClassPopup(true);
  };
  ...
  return (
    ...
    <div>
      <h1 className="    mr-2 ml-2  ">
        ...
        <div className="flex items- center ml-7 ">
          <div className="flex flex-row ">
            <div className=" w-[20px] text-left text-sm  mt-5 font-[calibri] font-bold">
              Center
            </div>
          ...
          <div className="flex flex-row items-center  ml-7">
            <div className=" font-[calibri] mt-2  text-sm font-bold">
              Exam Date
            </div>
            <div className="flex flex-row  mt-2 ">
              ...
              <div className=" w-[2px]  font-[calibri] text-md mr-7 ml-1">
                {" "}
                To{" "}
              </div>
        ...
        <div className=" flex items-center    ">
          <div className=" text-left mt-4 ml-7 text-sm font-[Calibri] font-bold">
            {" "}
            Vehicle Class
          </div>
          <div className="ml-7 mt-3">
            <Button
              ...
              //variant="bordered"
              size="sm"
              onClick={handleAvailableVehicleClassPopup}
            >
              Add Class
            </Button>
          </div>
      ...
      <div>
        <h1 className="    mr-2 ml-2 mt-4 ">
          ...
          <div className="flex items- center ml-7 ">
            ...
            <div className="flex flex-row items-center ml-7 ">
              <div className=" font-[calibri] mt-2 items-left text-sm font-bold">
                Exam Date
              </div>
              <div className="flex flex-row  mt-2 ">
                <div className="inline-flex border border-solid border-[lightgray] w-[250px] ml-3  h-8">
          ...
          <div className="text-left ">
            <div className="flex  mt-1  w-[100%] ml-7">
              <div className="border border-[lightgray] w-[94%] mt-2  ">
                <div className=" h-[75px] overflow-y-scroll  w-[100%]">
     ...
     {showAvailableVehicleClassPopup && (
      <AvailableVehicleClassPopup
        showAvailableVehicleClassPopup={
          showAvailableVehicleClassPopup
        }
        closeAvailableVehicleClassPopup={
          setAvailableVehicleClassPopup
        }
      ></AvailableVehicleClassPopup>
    )}
    </>
...
export default AvailableExamQuto;