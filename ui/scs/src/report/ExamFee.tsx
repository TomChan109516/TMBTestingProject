        ...
        <h1 className="    mr-2 ml-2 mt-4 ">
          ...
          <div className="flex items- center ml-7 mt-2">
            <div className="flex flex-row items-center ">
              <div className=" font-[calibri] mt-2  items-left text-left text-sm font-bold">
                Exam Date
              </div>
              <div className="flex flex-row  mt-2 ">
                ...
                <div className="  w-[2px]  font-[calibri] text-md mr-10 ml-3">
                  {" "}
                  To{" "}
                </div>
          ...
          <div className="flex items- center  mt-2">
            <div className="flex flex-row items-center ml-2 ">
              ...
              <div className="flex flex-row  mt-2 ">
                ...
                <div className="  w-[2px]  font-[calibri] text-md mr-10 ml-1 ">
                  {" "}
                  To{" "}
                </div>
            ...
            <div className="flex flex-row items-center ml-3 ">
              <div className=" font-[calibri] mt-2   text-left text-sm font-bold">
                Exam Date
              </div>
              <div className="flex flex-row  mt-2 ">
