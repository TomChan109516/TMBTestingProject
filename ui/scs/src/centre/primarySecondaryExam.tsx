...
const AmendExam = (props) => {
  ...
  const examCentres = useSelector((state) => state.login.centres);
    ...
    <div>
      ...
      <div>
        <div className="grid grid-col-2 grid-flow-col pt-[0.5px] pb-0">
          <div className="text-[11px] font-bold text-left ml-2 mt-1">
            Primary Exam
          </div>
          <div className="text-[11px] font-bold text-left ml-10 mt-1">
            Supplementary Exam
          </div>
        </div>
        <div className="grid grid-col-2 grid-flow-col pt-1 h-[230px] w-[98%]">
          <div className="text-[9px] h-[230px] max-w-[500px] w-[265px] pl-1 ml-1.5 overflow-y-auto overflow-x-hidden border-2 border-[lightgray]">
          ...
          <div className="text-[9px] h-[230px] max-w-[500px] w-[265px] pl-5 ml-1.5 overflow-y-auto overflow-x-hidden border-2 border-[lightgray]">
            <CheckboxGroup
              className="pt-2"
              value={checkedList}
          ...
          <div className="flex">
            <div className="flex-initial w-[50%]">
              <div className="flex ">
                ...
                <div className="flex-initial w-[265px]">
