...
const LaneReallocationConfirmAppointmentTable = (props) => {
  const tableData = React.useMemo(() => props.tableData, [props.tableData]);
  console.log(props.isOrignalLane);
  ...
  return (
    <div className="mt-8 ml-1">
      <div className="mr-1">
        ...
        <div className="mt-3 flex flex-row justify-center -ml-44">
          <Button
...
export default LaneReallocationConfirmAppointmentTable;
