...
import LaneReallocationConfirmedAppointmentTable from "./LaneReallocationConfirmedAppointmentTable";

const dummyTableData = [
  {
    reallocated_laneID: "01",
    reg_marks: "ZZ7777",
    chassiss_no: "MCR300000285555",
    exam_code: "008",
    veh_class: "001",
    date: "01/12/2022 11:15",
    session: "AM2",
    appointment_no: "400000000394",
  },
  {
    reallocated_laneID: "01",
    reg_marks: "AB1234",
    chassiss_no: "MBB300000285555",
    exam_code: "008",
    veh_class: "001",
    date: "01/12/2022 11:15",
    session: "PM2",
    appointment_no: "400000000396",
  },
  {
    reallocated_laneID: "01",
    reg_marks: "CD7789",
    chassiss_no: "MGB300000285555",
    exam_code: "008",
    veh_class: "001",
    date: "01/12/2022 11:15",
    session: "PM2",
    appointment_no: "400000000395",
  },
];

function LaneReallocationConfirmed() {
  ...
  return (
    <div>
      ...
      <LaneReallocationConfirmedAppointmentTable tableData={dummyTableData} />
    </div>
  );
}
export default LaneReallocationConfirmed;
