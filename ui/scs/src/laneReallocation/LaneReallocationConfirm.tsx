...
import LaneReallocationConfirmAppointmentTable from "./LaneReallocationConfirmAppointmentTable";
...
function LaneReallocationConfirm() {
  ...
  return (
    <div>
      ...
      <LaneReallocationConfirmAppointmentTable
...
export default LaneReallocationConfirm;
