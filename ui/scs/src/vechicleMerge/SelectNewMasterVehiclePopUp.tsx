...
import AddMasterVechicleTableType from "./AddMasterVehicleTableType";
import SearchMasterVehicle from "./SearchMasterVehicleType";


function SelectNewMasterVehiclePopUp(props) {

  const SelectNewMasterVehiclePopUp = props.showSelectNewMasterVehiclePopUp;

  const handleClose = () => {
    props.setSelectNewMasterVehiclePopUp(false);
  };
  return (
    <>
      <Modal isOpen={SelectNewMasterVehiclePopUp} onClose={handleClose} size="full" className="w-[80%] h-[100%] overflow-y-auto">
        <ModalContent>
          <>
            ...
            <ModalBody>
              <div className="mt-[5px] w-[100%]">
                <div className="flex">
                  <div className="flex-initial text-[#0a923d] p-[0px] ml-[15px] font-bold text-[12px]">
                    View Master Vehicle
                  </div>
                </div>
                <div>
                  <div className="ml-1">
                    ...
                    <div className="mt-[12px] ml-2 mr-2">
                      <h1>
                        <h5 className="absolute -top-2 start-3 pl-[10px] pr-[10px] text-[12px] text-[#00AF8F] w-[170px] text-center">
                          Search Master Vehicle
                        </h5>
                          ...
                          <div className="col-span-4 ">
                            <div className="text-[10.5px] font-bold flex flex-row  ">
                              <div className="grid grid-rows-6 mt-2 h-[200px] grid-flow-col whitespace-nowrap w-4/5 ml-[40px]">
                                <div className="flex flex-row  pt-[15px] w-[100%] h-2">
                                  <div className="ml-2  text-left  text-[11px] font-bold mt-[5px] w-[26.5%] ">
                                    Vehicle Id
                                  </div>
                                  <div className=" h-20 w-[90%] pl-8 " >
                                    <Input
                                      variant="bordered"
                                      radius="none"
                                      name="regMark"
                                ...
                                <div className="flex flex-row  pt-[15px] w-[100%] mt-[5px] ">
                                  <div className="ml-2  text-left  text-[11px] font-bold mt-[5px] w-[25.5%]">
                                    Vehicle Class
                                  </div>
                ...
                <div className="m-[10px] ">  <CurrentMasterVehicleTableType /></div>

                <AddMasterVechicleTableType />
              </div>
            </ModalBody>
...
SelectNewMasterVehiclePopUp.propTypes = {
  showSelectNewMasterVehiclePopUp: PropTypes.string,
  closSelectNewMasterVehiclePopUp: PropTypes.func,
};

export default SelectNewMasterVehiclePopUp;
