...
import { ChangeOfVehicleParticularsPopup } from "../inputCertificateView/ChangeOfVehicleParticularsPopup";



export default function CertificateEditi() {
        ...
        <div>
            <div className="mr-1 mt-5 ml-1">
              <h1>
                  ...
                  <div className="flex items-center ">
                    <div className="   items-center ml-2">
                      <CheckboxGroup radius="none" size="sm">
                        <Checkbox
                          classNames={{ wrapper: "after:bg-[#00af8f] before:bg-[#e5e7eb]" }}
                        ></Checkbox>
                      </CheckboxGroup>
                    </div>
                ...
                <div className=" m-3  bg-[#fef2f2] border-[#d1d2d6] border-[2px] solid rounded-sm">
                  <div className="flex items-center ">
                    <div className="   items-center ml-2">
                      <CheckboxGroup radius="none" size="sm">
                        <Checkbox
                ...
                {isOpen ? (
                  <div className="flex-grow  ">
                    <div
                      className=" text-right mr-3 text-sm  text-[#008FAF] cursor-pointer "
                      style={{ fontStyle: "italic" }} onClick={handleopen}
                      
                    >
                      Collaspe 
                    </div>
                    <div className=" m-3 mt-1  bg-[#fef2f2] border-[#d1d2d6] border-[2px] solid rounded-sm">
                      <div className="flex items-center ">
                        <div className="   items-center ml-2">
                          <CheckboxGroup radius="none" size="sm">
                            <Checkbox
                    ...
                    <div className=" m-3  bg-[#f0fdfa] border-[#d1d2d6] border-[2px] solid rounded-sm">
                      <div className="flex items-center ">
                        ...
                        <div className="flex  items- center ml-10">
                          <div className="ml-12">
                            <div className=" mt-4  mr-4  ml-9 text-sm  font-[Calibri] text-black font-bold ">
                              Certificate No.
                            </div>
                          </div>
                          <div className=" w-[150px] mt-3">
                    ...
                    <div className=" m-3  bg-[#f0fdfa] border-[#d1d2d6] border-[2px] solid rounded-sm">
                      <div className="flex items-center ">
                        ...
                        <div className="flex  items- center ml-10">
                          <div className="ml-12">
                            <div className=" mt-4  mr-4 ml-8  text-sm  font-[Calibri] text-black font-bold ">
                              Certificate No.
                            </div>
                          </div>
                          <div className=" w-[150px] mt-3">
                    ...
                    <div className=" m-3  bg-[#f0fdfa] border-[#d1d2d6] border-[2px] solid rounded-sm">
                      <div className="flex items-center ">
                        ...
                        <div className="flex  items- center ml-10">
                          <div className="ml-12">
                            <div className=" mt-4  ml-8 mr-4  text-sm  font-[Calibri] text-black font-bold ">
                              Certificate No.
                            </div>
                          </div>
                          <div className=" w-[150px] mt-3">
                  ...
                  <div>
                    <div
                      className=" text-right mr-5  mb-3 text-sm  text-[#008FAF] cursor-pointer"
                      style={{ fontStyle: "italic" }} onClick={handleopen}
                    >
                      More....
                    </div>
