...
function DisableExaminationTypeandTestItems(props) {
  const handleClose = () => {
    props.setDisableExamination(false);
  };
  return (
    <>
      <Modal
      className="rounded-md"
        ...
        <ModalContent>
          {(onClose) => ( <>
              ...
              Disable Examination Type and Test Items
              </ModalHeader>
              <ModalBody>
                <div className="justify-center text-center text-black font-calibri font-bold mt-2">
                  Do you confirm to disable This Examination 
                  <br />
                  Type and Test Items? 
                   <br />
                </div>
...
export default DisableExaminationTypeandTestItems;
