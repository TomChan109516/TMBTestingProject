...
export function DisablePassingStandardPopUp({setIsDisablePassingStandard}) {

  const setDisablePassingStandard=() => {
    setIsDisablePassingStandard(false)
  }
  ...
  return (
    <div className="w-screen h-screen">
      <Modal
        ...
        isOpen={true}
        onClose={setDisablePassingStandard}
        isDismissable={false}
        size="full"
        className="w-[40%]  h-[35%] "
      >
        ...
        <div className="bg-lightGreen w-[100%]  text-[12px] p-1 font-bold text-black text-center h-9">Disable Passing Standard</div>
          ...
          <div className="flex justify-center mb-20 mt-4 ml-8">
            ...
            <Button
              ...
              size="sm"
              radius="none"
              onClick={setDisablePassingStandard}
            >
              No
            </Button>
          </div>
...
export default DisablePassingStandardPopUp;