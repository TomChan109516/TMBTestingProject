...
export function ReactivePassingStandardPopUp({ setIsReactivatePassingStandard }) {
  const setReactivatePassingStandard = () => {
    setIsReactivatePassingStandard(false)
  }
  ...
  return (
    <div className="w-screen h-screen">
      <Modal
        isOpen={true}
        onClose={setReactivatePassingStandard}
        isDismissable={false}
        size="full"
        className="w-[40%]  h-[35%] "
      >
        <ModalContent>
          ...
          <div className="bg-lightGreen w-[100%]  text-[12px] p-1 font-bold text-black text-center h-9">Reactive Passing Standard</div>
          ...
          <div className="flex justify-center mb-20 mt-4 ml-8">
            ...
            <Button
              ...
              size="sm"
              radius="none"
              onClick={setReactivatePassingStandard}
            >
              No
            </Button>
          </div>
...
export default ReactivePassingStandardPopUp;