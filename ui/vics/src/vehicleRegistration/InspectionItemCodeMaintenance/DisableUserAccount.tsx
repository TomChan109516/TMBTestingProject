          ...
          {(onClose) => (
            <>
              ...
              <ModalFooter className="justify-center mb-6 ">
                <Button
                  className="text-white font-calibri font-bold bg-persianGreen border-greyBorder  rounded-sm ml-4"
                  variant="light" 
                  onPress={onClose}
                >
                  Yes
                </Button>
                <Button className="text-black font-calibri font-bold rounded-sm bg-white border-1 border-greyBorder ml-6" onClick={handleClose}>
                  No
                </Button>
              </ModalFooter>
            </>
...
DisableUserAccount.propTypes = {
    showDisableUserAccount: PropTypes.bool,
    closeDisableUserAccount: PropTypes.func,
  }
