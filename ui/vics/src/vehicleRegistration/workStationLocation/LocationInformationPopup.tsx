...
const LocationInformationPopup = (props) => {
  const open = props.showLocationInformationPopup;
  const handleClose = () => {
    props.closeLocationInformationPopup(false);
  };
  return (
    <>
      <Modal
...
LocationInformationPopup.propTypes = {
  showLocationInformationPopup: PropTypes.bool,
  closeLocationInformationPopup: PropTypes.func,
};
