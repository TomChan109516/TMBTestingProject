...
export default function ReportGeneration() {
    const handlePrintExaminationReport = async () => {
        try {
          const response = "/Examiation_report.pdf";
    ...
    return (
        <>
            <div className='flex w-[100%] font-calibri '>
                ...
                <div className='w-[15%]'>
                    ...
                    <div>
                        <Button
                            size="sm"
                            className="bg-persianGreen font-bold text-white h-8 rounded w-[100%]"
                            radius="none"
                            onClick={handlePrintExaminationReport}
                            >Print Examination Report</Button>
