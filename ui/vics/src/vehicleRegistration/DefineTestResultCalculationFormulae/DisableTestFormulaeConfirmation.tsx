...
export function DisableTestFormulaeConfirmation({setIsDisableTestFormulaeConfirmation}) {
  const setDisableTestFormulaeConfirmation=() => {
    setIsDisableTestFormulaeConfirmation(false)
  }
  return (
    <div className="w-screen h-screen">
      <Modal
        ...
        isOpen={true}
        onClose={setDisableTestFormulaeConfirmation}
        isDismissable={false}
        size="full"
        className="w-[40%]  h-[35%] "
      >
        <ModalContent> 
        <div className="bg-lightGreen w-[100%]  text-[12px] p-1 font-bold text-black text-center h-9">Disable Test Formulae</div>
          <ModalBody>
            <div className="flex flex-row items-center justify-center ml-6 mt-5 mb-2" data-testId="Do you confirm to disable this Disable Passing Standard">
              ...
              >
                <b>Do you confirm to disable this Test Formulae</b>
              </p>
            </div>
          ...
          <div className="flex justify-center mb-20 mt-4 ml-8">
            ...
            <Button
              ...
              size="sm"
              radius="none"
              onClick={setDisableTestFormulaeConfirmation}
            >
              No
            </Button>
          </div>
...
export default DisableTestFormulaeConfirmation;