...
function ReactivateVehicle({setIsReactivateVehicle}) {
  
  function handleClose(){
    setIsReactivateVehicle(false);
  }
  return (
          ...
          {() => (
            <>
              <ModalHeader className="flex flex-col text-black bg-lightGreen font-calibri font-bold  text-center i justify-center  gap-1">
               Reactivate Vehicle Model Exemption
              </ModalHeader>
              <ModalBody>
                <div className=" text-center i justify-center mt-8">
                    <span className="text-[14px] font-bold">Do you confirm to reactivate this Model Vehicle Exemption?</span>
                </div>
...
export default ReactivateVehicle;