...
const GenerateReport = () => {
  ...
  const [showVoidExam, setshowVoidExam] = useState(false);
  const handleVoidExam = () => {
    setshowVoidExam(true);

  };
  const closeVoidExam = (val) => {
    setshowVoidExam(val);
  };
  ...
  const closePrintReport = (val) => {
    setshowPrintReport(val);
  };

  return (
    <>
    
      <div className="flex w-[100%] font-calibri mt-20 ml-10 p-10">
        <h1 className="w-[70%] mr-6 border-1 rounded-none border-darkGrey p-5">
          ...
          <div className="border-2 border-darkGrey p-3 m-5">
            <Textarea
              ...
              radius="none"
              placeholder=""
              className="max-w-xs mb-4 w-60 h-30 "
        ...
        <div className="w-[15%]  ">
          ...
          <div>
            ...
            <Button
              size="sm"
              className="bg-persianGreen mt-0font-bold text-white h-8 rounded  w-[100%] m-2"
              radius="none"
              onClick={handleVoidExam}
            >
        ...
        <Button
        size="sm"
        className="bg-orange font-bold text-white h-8 rounded  w-[100%] m-2"
        radius="none"
...
<VoidExam
  showVoidExam={showVoidExam}
  closeVoidExam={closeVoidExam}>
</VoidExam>
)}
