    ...
    <div className="flex w-[100%] font-calibri mt-20 ml-10 p-10">
        ...
        <div className="border-2 border-darkGrey p-3 m-5">
          ...
          <div className="flex justify-between w-[100%] text-innerInputTxt text-start  mb-4">
            <div className="flex flex-col w-[33.3%] text-start">
              <p>
                Exam. Date & Time <span className="ml-6">17-10-2023 10:08</span>
              </p>
              <p>
                Vehicle Reg.Mark <span className="ml-8 font-bold">111210</span>
              </p>
              <p>
      ...
      <div className="w-[15%]  ">
        ...
        <div>
          <Button
            size="sm"
            className="bg-darkGrey font-bold text-white h-8 rounded w-[100%] m-2"
            radius="none"
          >
