...
export function DisableExemption({ setIsDisableExemption }) {
  const setDisableExemption = () => {
    setIsDisableExemption(false);
  };
  return (
    <div className="w-screen h-screen">
      ...
      >
        <ModalContent>
          <ModalHeader>
            <div className="ml-[250px]">Disable Vehicle Exemption</div>
          </ModalHeader>
          <ModalBody>
            <div className="flex flex-row items-center justify-center ml-6 mt-7 mb-2">
              ...
              >
                <b>Do you confirm to disable this Vehicle Exemption</b>
              </p>
            </div>
...
export default DisableExemption;
