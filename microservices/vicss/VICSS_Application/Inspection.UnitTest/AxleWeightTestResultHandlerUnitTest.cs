namespace VICSS.Test.Services.Inspection.UnitTest
{
    ...
    public class AxleWeightTestResultHandlerUnitTest
    {
        [Fact]
        public async Task HandleRequestIsNullReturnsBadRequest()
        {
            var _mockMapper = new Mock<IMapper>();
            var _mockGenericRepository = new Mock<IGenericRepository<InspectionDBContext, TestResultAxleWeight>>();
            ...
            var handler = new AxleWeightTestResultHandler(_mockMapper.Object, _mockGenericRepository.Object, _mockGenericTestItemRepository.Object, _mockGenericTestRepository.Object, _mockUnitOfWork.Object, _mockGenericStationRepository.Object);
        ...
        public async Task HandleValidRequestReturnsOk()
        {
            ...
            var _mockGenericStationRepository = new Mock<IGenericRepository<InspectionDBContext, Station>>();
            var _mockUnitOfWork = new Mock<IUnitOfWork<InspectionDBContext>>();
            var request = new AxleWeightTestResultRequestDto()
            {
                TestDto = new TestDto() { InspectionId = "test", AbortSuspendTestReasonId = "" },
                AxleWeightTestResultDto = new AxleWeightTestResultDto { Result = "P",SkipTestReasonId="" }
            };
            ...
            var testList = new List<Test>
            {
                new Test
                {
                    ...
                    Attempt=1,
                    Mode="Auto",
                    TestItems = new TestItems { TestItem = CommonConstants.AxleWeightbridgeTest }
                }
            };
            var axleList = new List<TestResultAxleWeight>
            {
                new TestResultAxleWeight
                {
                    TestId="test",
                    Result="P"
                }
            ...
            _mockGenericRepository
               .Setup(repo => repo.GetByQuery(It.IsAny<Expression<Func<TestResultAxleWeight, bool>>>()))
               .ReturnsAsync((Expression<Func<TestResultAxleWeight, bool>> predicate) => axleList.Where(predicate.Compile()).ToList());
            ...
            _mockMapper.Setup(x => x.Map<TestResultAxleWeight>(It.IsAny<object>())).Returns(new TestResultAxleWeight()
            {
                TestId = "test",
                Result = "P"
            });
        ...
        public async Task HandleStationNotFoundReturnsBadRequest()
        {
            ...
            var request = new AxleWeightTestResultRequestDto()
            {
                ...
                AxleWeightTestResultDto = new AxleWeightTestResultDto { Result = "P" }
            };
