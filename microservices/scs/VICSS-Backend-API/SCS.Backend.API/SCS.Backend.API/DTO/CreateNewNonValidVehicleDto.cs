...
{
    public class CreateNewNonValidVehicleDto
    {
        ...
        public string LastRecordedTranscTypeCode { get; set; } = string.Empty;
        public string VehicleSubClassId { get; set; }//vehicle subclass code
    }

    public class CreateNewNonValidVehicleDtoResponse : HttpStatusResponse
    {
        public CreateNewNonValidVehicleDto? data { get; set; }
    }
}
