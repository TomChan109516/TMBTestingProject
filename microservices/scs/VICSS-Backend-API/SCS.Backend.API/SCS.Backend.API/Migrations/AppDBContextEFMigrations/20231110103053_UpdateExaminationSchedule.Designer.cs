...
namespace SCS_Backend_API.Migrations.AppDBContextEFMigrations
{
    ...
    [Migration("20231110103053_UpdateExaminationSchedule")]
    partial class UpdateExaminationSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCS_Backend_API.Models1.VehicleMessages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SCS_Backend_API.Models1.ExaminationScheduleDetails", b =>
                {
                    b.HasOne("SCS_Backend_API.Models1.ExaminationSchedule", "ExaminationSchedule")
                        .WithMany("ExaminationScheduleDetails")
                        .HasForeignKey("VisExamScheduleKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExaminationSchedule");
                });
            ...
            modelBuilder.Entity("SCS_Backend_API.Models1.VehicleMessages", b =>
                {
                    b.HasOne("SCS_Backend_API.Models1.VehicleInformation", "VehicleInfo")
                        .WithOne("VehicleMessage")
                        .HasForeignKey("SCS_Backend_API.Models1.VehicleMessages", "VehicleId")
                        .HasPrincipalKey("SCS_Backend_API.Models1.VehicleInformation", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SCS_Backend_API.Models1.ExaminationSchedule", b =>
                {
                    b.Navigation("ExaminationScheduleDetails");
                });
