...
namespace SCS_Backend_API.Migrations
{
    ...
    [Migration("20231004120702_Appointment Table Updated with Payment Status")]
    partial class AppointmentTableUpdatedwithPaymentStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCS_Backend_API.Models.BookingChannel", b =>
                {
            ...
            modelBuilder.Entity("SCS_Backend_API.Models.ExamSlot", b =>
                {
                    ...
                    b.ToTable("ExamSlotsInformation");
                });
            ...
            modelBuilder.Entity("SCS_Backend_API.Models.SubClass", b =>
                {
                    b.Property<int>("VehicleSubClassKey")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VehicleSubClassKey"));
            ...
            modelBuilder.Entity("SCS_Backend_API.Models.VehicleMake", b =>
                {
                    b.Property<long>("MakeKey")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("MakeKey"));
            ...
            modelBuilder.Entity("SCS_Backend_API.Models.Appointment", b =>
                {
                    b.HasOne("SCS_Backend_API.Models.BookingChannel", "BookingChannel")
            ...
            modelBuilder.Entity("SCS_Backend_API.Models.SubClass", b =>
                {
                    b.HasOne("SCS_Backend_API.Models.VehicleClass", "VehicleClass")
                        .WithMany("SubClasses")
